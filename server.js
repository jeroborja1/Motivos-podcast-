// Servidor estático sin dependencias para Motivos Podcast.
// Uso: node server.js  (opcional: PORT=4000 node server.js)
...
server.listen(PORT, () => {
  console.log(`\n  Motivos Podcast corriendo en:  http://localhost:${PORT}\n`);
});
